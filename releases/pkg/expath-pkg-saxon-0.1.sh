...
## explanation of the options.  Options --catalog and --proxy
## are mutually exclusive (when a proxy user is used.)
##
...
usage () {
    ...
    echo "  --repo=...                set the EXPath Pkg repository dir"

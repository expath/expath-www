...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:gdata="http://fgeorges.org/ns/xslt/google/data"
                xmlns:gc="http://fgeorges.org/ns/xslt/google/contacts"
                xmlns:gmap="http://fgeorges.org/ns/xslt/google/maps"
   ...
   <xsl:import href="http://fgeorges.org/ns/xslt/google/gdata.xsl"/>
   <xsl:import href="http://fgeorges.org/ns/xslt/google/gcontacts.xsl"/>
   <xsl:import href="http://fgeorges.org/ns/xslt/google/gmaps.xsl"/>
   ...
   <xsl:variable name="impl:cp-service" as="element(gdata:service)" select="
       gc:make-login-contact-service($user, $pwd)"/>
